...
OverDrive.Game = (function(gamelib, canvas, context) {
  ...
  gamelib.Player = function(config) {
	...
	this.speedUp = function(speedDelta){
		
		this.forwardForce = this.forwardForce + speedDelta;
		console.log("Speed increase");
	}
	
	
	this.slowDown = function(speedDelta2){
		
		this.forwardForce = this.forwardForce - speedDelta2;
		console.log("Speed decline");
	}
    ...
    this.collideWithPlayer = function(otherPlayer, env) {
      ...
      console.log('Oi, knock it off! (collide with player)');
    }
